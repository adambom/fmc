...
<tr>
	...
	<th><?php echo $paginator->sort('probability');?></th>
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action' => 'view', $stage['Stage']['id'])); ?>
			<?php echo $html->link(__('Edit', true), array('action' => 'edit', $stage['Stage']['id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action' => 'delete', $stage['Stage']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $stage['Stage']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
