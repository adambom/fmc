...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action' => 'view', $jobcategory['Jobcategory']['id'])); ?>
			<?php echo $html->link(__('Edit', true), array('action' => 'edit', $jobcategory['Jobcategory']['id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action' => 'delete', $jobcategory['Jobcategory']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $jobcategory['Jobcategory']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
